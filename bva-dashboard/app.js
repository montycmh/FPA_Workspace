...
(function(){
  ...
  async function downloadHtml(){
    ...
    try{
      ...
      clone.querySelectorAll('.hidden, .del-btn, .del-block, .add-act, .mini-btn, .ghost-btn, .topbar-actions, #save-nav, #download-nav, #download-pdf-nav').forEach(el => el.remove());
  ...
  async function downloadPdf(){
    ...
    const hiddenEls = Array.from(target.querySelectorAll('.hidden, .del-btn, .del-block, .add-act, .mini-btn, .ghost-btn, .topbar-actions'));
